...
public class HttpDemo {
    ...
    public static User createNewUser() {
        ...
        adress.setStreet("Garibaldi");
        adress.setSuite("Apt. 51");
        adress.setCity("Kharkov");
        adress.setZipcode("61000");
        Geo geo = new Geo();
        geo.setLat("49°58.8486′");
        geo.setLng("36°15.1632");
        adress.setGeo(geo);
        user.setAddress(adress);
        user.setPhone("0-800-859-5263");
        user.setWebsite("alex.com");
